...
#define Y(a) size.y * a / 600
	...
	auto inputText = new wxStaticText(pInputPanel, wxID_ANY, wxT("Input"), wxPoint(X(70), Y(10)),
									  wxSize(X(30), Y(30)));
	inputText->Show(true);
	...
	auto b1Text = new wxStaticText(pInputPanel, wxID_ANY, wxT("B1"), wxPoint(X(110), Y(60)),
								   wxSize(X(30), Y(30)));
	b1Text->Show(true);
	...
	auto b2Text = new wxStaticText(pInputPanel, wxID_ANY, wxT("B2"), wxPoint(X(110), Y(130)),
								   wxSize(X(30), Y(30)));
	b2Text->Show(true);
	...
	auto b1Box = new wxTextCtrl(pInputPanel, ID_B1_BOX, "0", wxPoint(X(100), Y(80)), wxSize(X(40), Y(20)));
	b1Box->Show(true);

	auto a2Box = new wxTextCtrl(pInputPanel, ID_A2_BOX, "0", wxPoint(X(40), Y(150)), wxSize(X(40), Y(20)));
	a2Box->Show(true);

	auto b2Box = new wxTextCtrl(pInputPanel, ID_B2_BOX, "0", wxPoint(X(100), Y(150)), wxSize(X(40), Y(20)));
	b2Box->Show(true);

	auto epsText = new wxStaticText(pInputPanel, wxID_ANY, wxT("Eps"), wxPoint(X(75), Y(200)), wxSize(X(30), Y(30)));
	epsText->Show(true);

	auto epsBox = new wxTextCtrl(pInputPanel, ID_EPS_BOX, "0", wxPoint(X(70), Y(220)), wxSize(X(40), Y(20)));
	epsBox->Show(true);

	auto tnText = new wxStaticText(pInputPanel, wxID_ANY, wxT("Tn"), wxPoint(X(50), Y(270)), wxSize(X(30), Y(30)));
	tnText->Show(true);
	auto tkText = new wxStaticText(pInputPanel, wxID_ANY, wxT("Tk"), wxPoint(X(110), Y(270)), wxSize(X(30), Y(30)));
	tkText->Show(true);
	auto tnBox = new wxTextCtrl(pInputPanel, ID_TN_BOX, "0", wxPoint(X(40), Y(290)), wxSize(X(40), Y(20)));
	tnBox->Show(true);
	tnBox->Enable(false);

	auto tkBox = new wxTextCtrl(pInputPanel, ID_TK_BOX, "0", wxPoint(X(100), Y(290)), wxSize(X(40), Y(20)));
	tkBox->Show(true);

	auto NText = new wxStaticText(pInputPanel, wxID_ANY, wxT("N"), wxPoint(X(75), Y(340)), wxSize(X(30), Y(30)));
	NText->Show(true);
	auto NBox = new wxTextCtrl(pInputPanel, ID_N_BOX, "0", wxPoint(70, 360), wxSize(40, 20));
	NBox->Show(true);

	auto calcButton = new wxButton(this, ID_RECALCULATE, wxT("Calculate"), wxPoint(X(40), Y(500)), wxSize(X(100),Y(30)));
	calcButton->Show(true);

	auto clearButton = new wxButton(this, ID_CLEAR, wxT("Clear"), wxPoint(X(40), Y(520)), wxSize(X(100),Y(30)));
